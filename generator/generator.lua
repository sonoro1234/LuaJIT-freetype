...
local defines = parser:take_lines([[gcc -E -dD -I ../freetype/ -I ../freetype/include/ ./outheader.h]],{[[freetype.-]]},"gcc")
os.remove"./outheader.h"
---------------------------
parser:parseItems() --do_parse()
...
cp2c.copyfile("./freetype_h.lua", "../freetype_h.lua")
os.remove("./freetype_h.lua")
